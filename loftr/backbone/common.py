...
"""
This file is taken from https://github.com/ultralytics/yolov5/blob/master/models/common.py
"""
...
class Conv(nn.Module):
    ...
    def __init__(
        self, c1, c2, k=1, s=1, p=None, g=1, d=1, act: Union[bool, nn.Module] = True
    ):
        super().__init__()
        self.conv = nn.Conv2d(
            c1, c2, k, s, autopad(k, p, d), groups=g, dilation=d, bias=False  # type: ignore
        )
...
class Bottleneck(nn.Module):
    # Standard bottleneck
    def __init__(
        self, c1, c2, shortcut=True, g=1, e=0.5, act: Union[bool, nn.Module] = True
...
class CrossConv(nn.Module):
    ...
    def __init__(self, c1, c2, k=3, s=1, g=1, e=1.0, shortcut=False):
        ...
        super().__init__()
        c_ = int(c2 * e)  # hidden channels
        self.cv1 = Conv(c1, c_, (1, k), (1, s))  # type: ignore
        self.cv2 = Conv(c_, c2, (k, 1), (s, 1), g=g)  # type: ignore
        self.add = shortcut and c1 == c2
...
class C3(nn.Module):
    ...
    def __init__(
        self, c1, c2, n=1, shortcut=True, g=1, e=0.5, act: Union[bool, nn.Module] = True
    ):  # ch_in, ch_out, number, shortcut, groups, expansion
        super().__init__()
        c_ = int(c2 * e)  # hidden channels
        self.cv1 = Conv(c1, c_, 1, 1, act=act)
...
class SPPF(nn.Module):
    ...
    def __init__(
        self, c1, c2, k=5, act: Union[bool, nn.Module] = True
