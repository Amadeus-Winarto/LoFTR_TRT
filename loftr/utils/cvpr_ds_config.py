...
_CN = CN()
_CN.BACKBONE_TYPE = "ConvNeXtFPN"  # options: ["ResNetFPN", "ConvNeXtFPN"]
...
_CN.MATCH_COARSE.MATCH_TYPE = "dual_softmax"  # options: ['dual_softmax']
_CN.MATCH_COARSE.SKH_ITERS = 3
_CN.MATCH_COARSE.SKH_INIT_BIN_SCORE = 1.0
_CN.MATCH_COARSE.SKH_PREFILTER = False
